...
// functions/get-guestbook.ts
var get_guestbook_exports = {};
__export(get_guestbook_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(get_guestbook_exports);
var import_axios = __toESM(require_axios2());
var handler = async () => {
  try {
    const res = await import_axios.default.get("https://api.github.com/gists/8086d7329fb0bf377805ab314afc0641", {
      headers: {
 ...
 * MIT Licensed
 */
//# sourceMappingURL=get-guestbook.js.map
